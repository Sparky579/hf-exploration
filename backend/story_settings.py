...
def build_default_story_setting() -> GlobalStorySetting:
    ...
    return GlobalStorySetting(
        title="向西中学校园危机",
        story_text=(
            "时间8后校园进入警报状态。警报前玩家可从正门、后门、国际部尝试逃离；警报后常规逃离通道关闭。"
            "正门与后门有死板保安长期阻拦，口头说服无效，必须先突破防线才可从该门离开。"
        ...
        opening_trigger_texts=[
            (
                "时间1 若主角位于东教学楼内部 则枯燥的数学课正如催眠曲般回荡。你埋下头偷偷按亮手机，一条爆炸性的消息突然跃入眼帘——《皇室战争：超现实大更新》！"
                "你激动得掌心微汗，必须立刻决断：是忍痛烧掉自己宝贵的流量？还是厚着脸皮去借同桌马超鹏的热点？又或者……强忍好奇当做什么都没发生？"
                "选择【流量更新/借马超鹏热点更新/不更新】三选一。"
            ),
            (
                "时间1 若选择流量更新 则开始按主角自身圣水规则计数，"
                "马超鹏变为离开校园状态并不可邀请。"
            ),
            (
                "时间1 若选择借马超鹏热点更新 则虽然蹭网的快乐无与伦比，但在不到1个时间单位里，数学老师老鹰般锐利的目光就锁定了你。"
            ...
            (
                ...
                "马超鹏不仅没跑，反而主动提出把他的主手机塞给你：“用我的！”接过手机的瞬间，你接管了他的强力卡组，圣水槽清零；而你原本被收走的手机从此无法找回。"
            ),
            (
