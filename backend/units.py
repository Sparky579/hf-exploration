...
def build_default_unit_cards() -> list[UnitCard]:
    ...
    return [
        ...
        UnitCard("电磁炮", attack=320, health=1600, move_speed=0.0, is_flying=False, unit_class="unit", attack_preference="prefer_unit"),
        ...
        UnitCard("重甲亡灵", attack=65, health=150, move_speed=1.9, is_flying=True, unit_class="unit", attack_preference="prefer_unit"),
    ]
