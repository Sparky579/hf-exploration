...
SCENE_PARAGRAPHS: dict[str, str] = {
    ...
    "图书馆": "一排排沉寂的书架。它既可能是你喘息待发的最后堡垒，也极易成为疯子们肆意倾泻火力的绝佳焚化炉。由于隔音效果太好，似乎有些同学还在专注地学习，甚至没能注意到外面的疯狂。",
    "小卖部": "原本充满欢声笑语和零食香气的转角小店，现在却成了连接食堂、北侧冰冷暗道和开阔田径场的兵家必争之地。跨过这里，步步杀机。",
    "东教学楼北": "终年不见阳光的北侧小道，隐蔽得连疯子都懒得多看一眼。也许有一个瑟瑟发抖的女孩，正缩在某个生满青苔的角落里绝望地祈求救援。",
