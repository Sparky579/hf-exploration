    ...
    return {
        ...
        "马超鹏": CharacterProfile(
            ...
            description=(
                ...
                "（重要注意：马超鹏把主手机直接交给主控玩家后，他本人不再持有手机设备，"
                "因此不可能再主动出牌；他的卡组仅作为主控玩家的专属卡组使用。）"
            ),
        ),
        "陈洛": CharacterProfile(
            name="陈洛",
            ...
            card_deck=["无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组"],
            description=(
                "南教学楼阶段事件角色。时间10前可在南教学楼遇到他。"
                "触发后他会用自己的手机对主控施放一次治疗法术（生命+3），随后离开校园，不再参与后续剧情。"
            ),
        ),
        "信息老师": CharacterProfile(
            name="信息老师",
            alignment="事件角色",
            card_deck=["无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组"],
            description=(
                "国际部常驻事件角色。警报前在国际部走廊巡视，看到你后会先冷静询问。"
                "若你直接动手且有远程单位，他会在冲突中死亡且该事件永久终止；否则攻击失败并立刻进入老师介入结算。"
                "若你不动手且游戏已安装，他会训诫“游戏就是毒品”并卸载你的皇室战争，但不会收走手机；卸载后你的所有圣水和单位直接消失。"
                "若游戏未安装，他只会进行约2时间单位的常规劝导，并封锁国际部出口阻止你翻出校园。"
                "强规则：只要你没有击杀信息老师，就不能从国际部顺利脱离；"
                "无论你尝试直接逃离国际部，还是试图往宿舍方向撤离，都会被他拦截并立刻进入“老师介入结算”流程（未安装时进入对应劝导分支但同样被阻断）。"
            ),
        ),
        "李秦彬": CharacterProfile(
            name="李秦彬",
            alignment="事件角色",
            card_deck=["无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组", "无战斗卡组"],
            description=(
                "食堂常驻事件角色。平时低头吃饭，不主动参与战斗。"
                "若主控提醒他校园异变（耗时1.5），他会很感激并给主控手机充值一枚皇室令牌。"
                "令牌效果仅对主控手机生效：可下牌窗口扩大到前8张（无视排序）。"
            ),
        ),
    }
